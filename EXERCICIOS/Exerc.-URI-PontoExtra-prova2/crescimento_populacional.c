...
exatamente o tempo para estes casos. Basta que você informe, nesta situação, a mensagem 
"Mais de 1 seculo.".

Entrada
A primeira linha da entrada contém um único inteiro T, indicando o número de casos de teste 
(1 ? T ? 3000). Cada caso de teste contém 4 números: dois inteiros PA e PB 
(100 ? PA ? 1000000, PA < PB ? 1000000) indicando respectivamente a população de A e B, e dois 
valores G1 e G2 (0.1 ? G1 ? 10.0, 0.0 ? G2 ? 10.0, G2 < G1) com um digito após o ponto decimal 
...
Saída
Imprima, para cada caso de teste, quantos anos levará para que a cidade A ultrapasse a cidade B 
em número de habitantes. Obs.: se o tempo for mais do que 100 anos o programa deve apresentar a 
